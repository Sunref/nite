...
\begin{frame}
    ...
    \begin{itemize}
    	\item Ferramentas utilizadas:
     	\begin{itemize}
    	 	\item Linguagem de programação C utilizada no editor de texto Zed; Biblioteca ncurses para C, CGG como compilador e terminal BlackBox para testes; Obsidian para gerenciamento de notas; Desenvolvido em uma máquina Linux
        \end{itemize}
