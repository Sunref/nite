...
\begin{tikzpicture}[node distance=0.8cm]
	...
	% ------------------------------------------------
	\node[box, fill=verdeClaro]       (n1) at (-5.6, 0.7) {1. Criar protótipo};
	...
	% ------------------------------------------------
	\node[box, fill=verdeClaro]       (n5) at (-5.6, -0.9) {5. Atalhos\\\textit{shortcuts} e modos};
...
\begin{frame}
    ...
    \begin{itemize}
    	\item Ferramentas utilizadas:
     	\begin{itemize}
    	 	\item Linguagem de programação C com a biblioteca ncurses utilizada no editor de texto Zed e GCC como compilador; Terminal BlackBox para testes; Obsidian para gerenciamento de notas; Desenvolvido em uma máquina Linux.
        \end{itemize}
