...
texto mais icônicos e amplamente utilizados no mundo UNIX. Já o Emacs
...
\subsection{Emacs}
O Emacs surge como uma opção de extrema extensibilidade, onde tudo pode ser programável via Lisp\footnote{Lisp é uma família de linguagens de programação, e foi projetada primariamente para o processamento de dados simbólicos. Ela é uma linguagem formal matemática.},
...
rápidas em configurações ou criação rápida de \textit{scripts}, como os \textit{scripts} \textbf{.sh}.
...
Já a Ncurses é um clone da \textit{Curses}, com suas melhorias. Teve início por volta de
1982 com Pavel Curtis sob o nome de Pcurses, e a partir de 1986, várias pessoas
